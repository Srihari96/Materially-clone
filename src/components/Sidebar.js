...
function Sidebar() {
    return (
        ...
        <>
            ...
            <SideBarIcon number='1' heading='Dashboard' isProElement=''
            ...
            />
            <SideBarDropdownIcon number="1" isProElement={isProElement}
            ...
            <SideBarIcon number='2' heading='RTL Layout' isProElement=''
            ...
            <SideBarDropdownIcon number="2" isProElement={isProElement}
            ...
            <SideBarDropdownIcon number="3" isProElement={isProElement}
            ...
            <SideBarDropdownIcon number="4" isProElement={isProElement}
                dropdownElements={['List', 'Card']}
                heading='Contacts'
                headingIcon={<><svg className='sidebar-icon' width='15' height='15'  focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM7.07 18.28c.43-.9 3.05-1.78 4.93-1.78s4.51.88 4.93 1.78C15.57 19.36 13.86 20 12 20s-3.57-.64-4.93-1.72zm11.29-1.45c-1.43-1.74-4.9-2.33-6.36-2.33s-4.93.59-6.36 2.33C4.62 15.49 4 13.82 4 12c0-4.41 3.59-8 8-8s8 3.59 8 8c0 1.82-.62 3.49-1.64 4.83zM12 6c-1.94 0-3.5 1.56-3.5 3.5S10.06 13 12 13s3.5-1.56 3.5-3.5S13.94 6 12 6zm0 5c-.83 0-1.5-.67-1.5-1.5S11.17 8 12 8s1.5.67 1.5 1.5S12.83 11 12 11z"></path></svg></>}
            />

            <SideBarIcon number='3' heading='Mail' isProElement={isProElement}
            ...
            <SideBarIcon number='4' heading='Chat' isProElement={isProElement}
            ...
            <SideBarDropdownIcon number="5" isProElement={isProElement}
            ...
            <SideBarDropdownIcon number="6" isProElement={isProElement}
            ...
            <SideBarDropdownIcon number="7" isProElement={isProElement}
            ...
            <SideBarDropdownIcon number="8" isProElement=''
            ...
            <SideBarDropdownIcon number="9" isProElement={isProElement}
            ...
            <SideBarIcon number='5' heading='Sample Page' isProElement={isProElement}
            ...
            <SideBarIcon number='6' heading='Multi-Language' isProElement=''
            ...
            <SideBarDropdownIcon number="10" isProElement=''
                dropdownElements={['Login', 'Register', 'Forget Password']}
                heading='Authentication'
                headingIcon={<><svg className='sidebar-icon' width='15' height='15'  focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM8 20H4v-4h4v4zm0-6H4v-4h4v4zm0-6H4V4h4v4zm6 12h-4v-4h4v4zm0-6h-4v-4h4v4zm0-6h-4V4h4v4zm6 12h-4v-4h4v4zm0-6h-4v-4h4v4zm0-6h-4V4h4v4z"></path></svg></>}
            />

            <SideBarDropdownIcon number="11" isProElement={isProElement}
            ...
            <SideBarDropdownIcon number="12" isProElement={isProElement}
            ...
            />
            <SideBarIcon number='7' heading='Coming soon' isProElement={isProElement}
            ...
            <button className="border-0 p-0 text-muted w-100 bg-white mt-3 sidebar-bttn" id='side-bar-icon-8' type="button">
            ...
            <SideBarIcon number='9' heading='Modal' isProElement={isProElement}
            ...
            />
            <SideBarIcon number='10' heading='Tooltip' isProElement={isProElement}
            ...
            />
            <SideBarIcon number='11' heading='Popover' isProElement={isProElement}
            ...
            />
            <SideBarIcon number='12' heading='Popper' isProElement={isProElement}
            ...
            />
            <SideBarIcon number='13' heading='Transitions' isProElement={isProElement}
            ...
            <SideBarIcon number='14' heading='Icons' isProElement=''
            ...
            />
            <SideBarIcon number='15' heading='Typography' isProElement=''
            ...
            <SideBarDropdownIcon number="13" isProElement={isProElement}
            ...
            <SideBarIcon number='16' heading={<><span className='text-muted'>Disabled Menu</span></>} isProElement=''
            ...
            <SideBarIcon number='17' heading='Oval Chip' isProElement={<><span className="badge rounded-pill text-bg-primary" style={{ fontWeight: "500" }}>9</span></>}
            ...
            <SideBarIcon number='18' heading='Rounded Chip' isProElement={<><span className="badge rounded-pill text-bg-secondary" style={{ fontWeight: "500" }}>Rounded</span></>}
            ...
            />
            <SideBarIcon number='19' heading='Avatar Chip' isProElement={<><span className="badge rounded-pill text-bg-primary" style={{ fontWeight: "500" }}>Coded</span></>}
            ...
            />
            <SideBarIcon number='20' heading='Outline Chip' isProElement={<><span class="badge rounded-pill text-bg-white text-primary border border-primary" style={{ fontWeight: "500" }}>Outline</span></>}
                headingIcon={<><svg className='sidebar-icon' width='15' height='15'  focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M10.25 13c0 .69-.56 1.25-1.25 1.25S7.75 13.69 7.75 13s.56-1.25 1.25-1.25 1.25.56 1.25 1.25zM15 11.75c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25zm7 .25c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10zM10.66 4.12C12.06 6.44 14.6 8 17.5 8c.46 0 .91-.05 1.34-.12C17.44 5.56 14.9 4 12 4c-.46 0-.91.05-1.34.12zM4.42 9.47c1.71-.97 3.03-2.55 3.66-4.44C6.37 6 5.05 7.58 4.42 9.47zM20 12c0-.78-.12-1.53-.33-2.24-.7.15-1.42.24-2.17.24-3.13 0-5.92-1.44-7.76-3.69C8.69 8.87 6.6 10.88 4 11.86c.01.04 0 .09 0 .14 0 4.41 3.59 8 8 8s8-3.59 8-8z"></path></svg></>}
            />
        </>
    )
