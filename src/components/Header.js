    ...
    return (
        <div className='container-fluid d-flex shadow-lg justify-content-between bg-primary p-2'>
            <div className='d-flex align-items-center'>
                ...
                <button className='btn btn-primary text-white p-0 d-none d-lg-block'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-list" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" />
                    </svg>
                </button>
                <button className='btn btn-primary text-white p-0 '  data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-list" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" />
                    </svg>
                </button>
            ...
            <div className='d-flex px-3 align-items-center'>
                ...
                <div className="dropdown">
                    ...
                    <ul className="dropdown-menu p-0 shadow" style={{ width: "220px" }}>
                        <li className="p-0">
                            <a className="dropdown-item h-100 p-3 header-dropdown-item" href="/#">
                                <div className='d-flex align-items-center'>
                                    ...
                                    <span className='ms-2' style={{ fontSize: "12px" }}>Settings</span>
                                </div>
                            </a>
                        </li>
                        <li className="p-0">
                            <a className="dropdown-item h-100 p-3 header-dropdown-item" href="/#">
                                <div className='d-flex align-items-center'>
                                    ...
                                    <span className='ms-2' style={{ fontSize: "12px" }}>Profile</span>
                                </div>
                            </a>
                        </li>
                        <li className="p-0">
                            <a className="dropdown-item h-100 p-3 header-dropdown-item" href="/#">
                                <div className='d-flex align-items-center'>
                                    ...
                                    <span className='ms-2' style={{ fontSize: "12px" }}>My Messages</span>
                                </div>
                            </a>
                        </li>
                        <li className="p-0">
                            <a className="dropdown-item h-100 p-3 header-dropdown-item" href="/#">
                                <div className='d-flex align-items-center'>
                                    ...
                                    <span className='ms-2' style={{ fontSize: "12px" }}>Lock Screen</span>
                                </div>
                            </a>
                        </li>
                        <li className="p-0">
